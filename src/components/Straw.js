...
처음 사용 전 반드시 깨끗이 세척해주세요
뜨거운 음료(60도 이상) 사용 시 화상 위험이 있으니 주의하세요
빨대 끝이 날카로우므로 어린이 사용 시 보호자 지도하에 사용하세요
얼린 음료나 아이스크림 등 딱딱한 것을 빨대로 찌르지 마세요

세척 및 관리:

사용 후 즉시 세척하여 음료 찌꺼기가 굳지 않도록 하세요
염소계 표백제나 연마제 사용을 피해주세요
완전히 건조한 후 보관하여 세균 번식을 방지하세요
청소 브러시 사용 시 과도한 힘을 주지 마세요

보관사항:

직사광선을 피하고 서늘하고 건조한 곳에 보관하세요
습기가 많은 곳에 장시간 보관하지 마세요
다른 금속 제품과 부딪혀 긁히지 않도록 주의하세요

사용 금지:

탄산음료 장시간 사용 금지 (압력으로 인한 변형 가능)
전자레인지나 오븐에 넣지 마세요
냉동고에 보관하지 마세요
...
일반택배: 주문 후 1-2일 내 출고, 2-3일 내 배송 완료
제주도 및 도서산간 지역: 추가 1-2일 소요

배송비:

30,000원 이상 주문 시 무료배송
30,000원 미만 주문 시 배송비 3,000원
제주도 및 도서산간 지역: 추가 3,000원

배송 안내:

주문 마감: 평일 오후 3시 (3시 이후 주문 시 다음날 출고)
토요일 오전 11시 이후, 일요일, 공휴일 주문 시 다음 영업일 출고
배송 중 파손 방지를 위해 안전 포장하여 발송

배송 조회:

출고 완료 시 SMS 및 이메일로 송장번호 안내
...
제품 미사용 및 포장 상태 완전한 경우
제품 구성품 전체 보유 시 (빨대, 브러시, 파우치)
제품 하자나 오배송의 경우 언제든지 가능
...
무상 AS: 구매 후 1년간 제조사 결함에 대한 무상 수리/교환
유상 AS: 고객 부주의로 인한 손상 시 부품 교체 서비스

진행 절차:

고객센터 연락 (1588-0000) 또는 온라인 문의
교환/환불 접수 및 반품 주소 안내
제품 반송 (교환 시 Zero Flow 배송비 부담)
검수 완료 후 교환품 발송 또는 환불 처리
환불 시 3-5 영업일 내 계좌 입금

고객센터:

전화: 1588-0000 (평일 9:00-18:00)
이메일: cs@zeroflow.co.kr
카카오톡: @zeroflow

환불 정보:

신용카드: 승인 취소 처리 (영업일 기준 3-5일)
실시간 계좌이체: 원거래 계좌로 입금 (영업일 기준 1-2일)
가상계좌: 환불 계좌 확인 후 입금 (영업일 기준 3-5일) */}
    </section>
  );
};
